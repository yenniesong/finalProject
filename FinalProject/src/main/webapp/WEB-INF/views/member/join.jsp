  ...
  <main id="main">
	...
	<div class="user-type">
		...
		<div class="checkbtn-bootcamp">
			<input type="radio" id="bootcamp" name="user-type" value="bootcamp">
			<label for="bootcamp">학원</label>
		</div>
	...
	<!-- 일반 회원가입 -->
	<form action="/member/student" method="post">
		<div id="student-fields" style="display: none;">
			<table id="student-fields">
				...
				<tr>
					...
					<td><input type="password" id="password_confirm"
						...
						<br>
						<button type="button" id="passwordbtn" onclick="checkPassword()">비밀번호 확인</button> <span
				...
				<tr>
					...
					<td><input type="text" id="employed" name="employed" placeholder="( 예  / 아니오  )만 입력" required></td>
				</tr>
				<tr>
			...
			<input type="submit" id="submit" class="member-btn" value="회원가입" > <input
				type="reset" id="reset" name="reset" class="member-reset" value="취소"
				onclick="historyback()">
		</div>
	</form>

	<!-- 학원 회원가입 -->
	<form action="/member/bootcamp" method="post">
		<div id="bootcamp-fields" style="display: none;">
			<table id="bootcamp-fields">
				...
				<tr>
					...
					<td><input type="text" id="bootcamp_manager" name="bootcamp_manager"
						placeholder="*,/,$,@ 특수문자 제외" required></td>
				</tr>
				<tr>
					<th><label for="email">이메일</label></th>
				...
				<tr>
					<th><label for="bootcamp_name">학원명</label></th>
					<td><input type="text" id="bootcamp_name" name="bootcamp_name"
						required></td>
				</tr>
				<tr>
...
<!-- 						name="bootcamp_manager" required></td> -->
<!-- 				</tr> -->
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="bootcamp_site" name="bootcamp_site"
						placeholder="www.----.-----" required></td>
				</tr>
			</table>
				<input type="submit" id="submit" class="boot-btn" value="회원가입"> <input
				type="reset" id="reset" name="reset" class="boot-reset" value="취소"
				onclick="historyback()">
		</div>
	</form>
		...
		<div id="company-fields" style="display: none;">
			<table id="company-fields">
				...
				<tr>
					...
					<td><input type="number" id="employee_cnt" name="employee_cnt"
						placeholder="-명 입력 X" required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="company_type" name="company_type"
						placeholder="2글자 이상입력" required></td>
				</tr>
				<tr>
				...
				<tr>
					<th><label for="major_business">주요사업</label></th>
					<td><input type="text" id="major_business"
						name="major_business" placeholder="입력해주세요" required></td>
				</tr>
			</table>
				<input type="submit" id="submit" class="company-btn" value="회원가입"> 
				<input type="reset" id="reset" name="reset" class="company-reset" value="취소"
				onclick="historyback()">
		</div>
	</form>
  </div>
  ...
  <script src="../resources/js/main_mina.js"></script>
